...
# some colors
set fish_color_autosuggestion fdba63
set fish_color_comment        381a0f
set fish_color_command        fcd997 --bold
set fish_color_valid_path     fdba63 --bold
set fish_color_error          e3a66d --bold
set fish_color_param          df6322
