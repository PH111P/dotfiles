...
# some colors
set fish_color_autosuggestion e2df04
set fish_color_comment        bae7d6
set fish_color_command        82e7e7 --bold
set fish_color_valid_path     e2df04 --bold
set fish_color_error          789c0c --bold
set fish_color_param          87e7e8
