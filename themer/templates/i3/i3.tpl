...
client.focused          {{level2bg}}    {{level2bg}}    {{level2fg}}    {{level2bg}}
client.focused_inactive {{level3bg}}    {{level3bg}}    {{level3fg}}    {{level3bg}}
client.unfocused        {{level4bg}}    {{level4bg}}    {{level4fg}}    {{level4bg}}
client.urgent           {{level1bg}}    {{level1bg}}    {{level1fg}}    {{level1bg}}

# Font for window titles. Will also be used by the bar unless a different font
# is used in the bar {} block below.
# This font is widely installed, provides lots of unicode glyphs, right-to-left
# text rendering and scalability on retina/hidpi displays (thanks to pango).
font pango:Sauce Code for Powerline 14
...
bindsym Mod1+Mod4+Shift+E move container to workspace E
...
bindsym Mod1+Mod4+E workspace E
...
exec_always "killall powerline-lemonbar; powerline-lemonbar -o -d -- -f 'IPAGothic-11'"
