...
# some colors
set fish_color_autosuggestion fca8ad
set fish_color_comment        fca8ad
set fish_color_command        fca8ad --bold
set fish_color_valid_path     fca8ad --bold
set fish_color_error          0f0b0f --bold
set fish_color_param          fca8ad
